...
import { useJobStatus, useJobs, useResultsPaginated, queryClient } from "@/lib/queries";
...
export default function PredictionModal() {
  const { activeJobId, clearActiveJobId, predictionModalOpen, closePredictionModal } = useJobStore();
  ...
  return (
    <>
      <Dialog open={predictionModalOpen} onOpenChange={handleOpenChange}>
        <DialogContent className="sm:max-w-3xl max-h-[85vh] overflow-y-auto">
          <DialogHeader>
            <DialogTitle>New Prediction</DialogTitle>
            <DialogDescription>
              Submit a single or batch prediction for farmer credit scoring.
            </DialogDescription>
          </DialogHeader>
